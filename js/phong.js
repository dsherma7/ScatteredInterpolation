...
function build_phong_lighting_dials() {
	...
	toolbar.append('text')
	       ...
	       .attr('x',cx - 40)
	       .attr('y',cy - 55)
	       .attr('class','tbl-bold _phong')


	var dial_gradient = toolbar.append('defs').classed('_phong',true)
	...
	toolbar.append('rect').classed('_phong',true)
			.attr('x',cx-32.5)
			.attr('y',cy)
			.attr('width',65)
			.attr('height',0.5)
	toolbar.append('text').classed('axis _phong',true)
...
function build_dial_colorbar(cnt) {
	...
	toolbar.append('g').attr('class','colorbar _phong')
			.selectAll('rect')
			.data(num_cols)
			.enter()
			.append('rect')
	...
	toolbar.append('text')
		   ...
		   .attr('y',cy+50)
		   .text('Sun Color')
		   .attr('class','axis _phong')
		   .attr('id','colorbar_lbl')

}

function reset_phong() {
	d3.selectAll('._phong').remove();
